function Footer() {
    return (
        <footer>
            <h2 className="footer-name">Cerelina Martinez</h2> {/* Fixed: class -> className */}
            ...
            <div className="footer-socials"> {/* Fixed: class -> className */}
                <a href="#" className="footer-soc" aria-label="Instagram"> {/* Fixed: class -> className */}
                ...
                <a href="#" className="footer-soc" aria-label="Telegram">
                ...
                <a href="#" className="footer-soc" aria-label="TikTok">
            ...
            <button className="footer-lang-btn">English / Filipino</button> {/* Fixed: class -> className */}

            <p className="footer-copy">@ 2026 Cerelina Martinez. All Rights Reserved.</p> {/* Fixed: class -> className */}
        </footer>
    );
}
