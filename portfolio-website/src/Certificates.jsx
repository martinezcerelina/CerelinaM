...
function Certificates() {
    ...
    return (
        <section id="certificates-section" ref={sectionRef}>
            <div className="cert-title pop-item" style={{ '--pop-delay': '0s', '--pop-rot': '-5deg' }}>
                <h1>Certificates</h1>    
            </div>
            ...
            <div className="cert-grid">
                {certificatesData.map((cert, index) => (
                    <div 
                        ...
                        style={{ 
                            transitionDelay: '.05s',
                            '--pop-delay': `${0.2 + index * 0.12}s`,
                            '--pop-rot': `${(index % 2 === 0 ? -1 : 1) * (5 + index * 2)}deg`
                        }} 
                        key={cert.id}
                    >
